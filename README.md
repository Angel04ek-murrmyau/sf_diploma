...
Перейдите в браузере на http://<IP Вашего сервера>:3000/connections/add-new-connection, выберите Loki, и вставьте в поле Connection http://loki:3000. Перейдите в раздел Data sources, выберите Loki, сверху выберите метрику, например jobs -> default/django-app, вы увидите примерно это: [Loki](images/loki.png).

Перейдите в браузере на http://<IP Вашего сервера>:3000/connections/add-new-connection, выберите Prometheus, и вставьте в поле Connection http://prometheus:9090. Перейдите в раздел Dashboards, и создайте новый дашборд. В качестве шаблона можете использовать дашборды Prometheus Blackbox Exporter и Node Exporter Full. Более подробную документацию по работе с Grafana Вы можете найти на https://grafana.com/docs/. В качестве примера прикладываю дашборд, отображающий свободное место на диске сервера, http статус код, статус, а также время отклика http. [Grafana dashboard](grafana.png). Вы можете настроить любые метрики. После выполнения всех шагов вы получите полностью автоматизированную систему мониторинга и оповещения, построенную на стеке Prometheus, Grafana и Loki.
